...
class AddGame(
    ...
    val players by argument(help = "Ordered list of the scoring of the event, i.e: winner loser. Use commas to separate teams, i.e: winner1 winner2 , loser1 loser2.").multiple(required = true)
