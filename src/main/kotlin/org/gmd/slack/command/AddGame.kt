...
class AddGame(
    ...
    val players by argument(help = "Ordered list of the scoring of the event, i.e: winner loser. Use underscore-separated players to build a team with several players.").multiple(required = true)
